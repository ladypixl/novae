const splitPortfolio = new SplitText("#gsap_h2_portfolio", {
  type: "chars",
  charsClass: "portfolio++"
});

// make appear the h2 and highlight the "é" character
const masterH2Portfolio = gsap.timeline({
  scrollTrigger: {
    trigger: "#gsap_h2_portfolio",
    toggleActions: "restart none none none",
    start: "top 80%",
    end: "+=400"
  }
});
masterH2Portfolio.add("start", 0);
masterH2Portfolio.add(
  gsap.fromTo(
    "#gsap_h2_portfolio",
    {
      opacity: 0,
...
// Next slide
const nextBtn = document.querySelector("#gsap_next_slide");
